...
export const fr_FR = {
  ...
  realms: [
    'Royaume du Devoir',
    "Royaume de l'Accomplissement",
    "Royaume de l'Artiste",
    'Royaume de la Musique',
    "Royaume de l'Écriture",
    "Royaume de l'Ingénieurie",
    'Royaume de la Cuisine',
    'Royaume du Jardinage',
    "Royaume de l'Apaisement",
    'Royaume du Physique',
    'Royaume de la Science',
    "Royaume de l'Exploration",
  ],
};
