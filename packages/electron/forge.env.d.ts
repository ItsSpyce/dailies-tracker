...
declare global {
  ...
  interface Window {
    commissionService: {
      getCommissions(unixDate: string): Promise<import('./types').Commission[]>;
      addCommission(
        description: string,
        realm: string,
        rewards: import('./types').Reward[]
      ): Promise<import('./types').Commission>;
    ...
    claimsService: {
      setupClaimsForToday(): Promise<import('./types').Reward[]>;
    ...
    rewardService: {
      getAvailableRewards(): Promise<import('./types').Reward[]>;
      addReward(
        description: string,
        amount: number,
        imageBase64: string
      ): Promise<import('./types').Reward>;
